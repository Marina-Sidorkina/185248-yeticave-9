...
<form class="form form--add-lot container <?=isset($errors) ? "form--invalid" : ""?>" action="../add.php" method="post" enctype="multipart/form-data">
  ...
  <div class="form__item form__item--file">
    ...
    <div class="form__input-file">
      <input class="visually-hidden" type="file" id="lot-img" value="<?=isset($lot["lot-img"]) ? $lot["lot-img"] : ""; ?>" name="lot-img">
  ...
  <div class="form__container-three">
    ...
    <div class="form__item form__item--small <?=isset($errors["lot-step"]) ? "form__item--invalid" : ""?>">
      ...
      <input id="lot-step" type="text" name="lot-step" placeholder="0" value="<?=isset($lot["lot-rate"]) ? $lot["lot-step"] : ""; ?>">
