...
<form class="form form--add-lot container
  ...
  <div class="form__container-two">
    <div class="form__item <?=isset($errors["lot-name"]) ? "form__item--invalid" : ""?>">
      ...
      <span class="form__error">
        <?=isset($errors["lot-name"]) ? $errors["lot-name"] : ""?>
      </span>
    </div>
  ...
  <div class="form__item form__item--wide
    ...
    <textarea id="message" name="message"
      placeholder="Напишите описание лота"><?=isset($lot["message"]) ? $lot["message"] : ""; ?>
    </textarea>
  ...
  <div class="form__item form__item--file">
    ...
    <div class="form__input-file">
      <input class="visually-hidden" type="file" id="lot-img"
        value="<?=isset($lot["lot-img"]) ? $lot["lot-img"] : ""; ?>" name="lot-img">
  ...
  <div class="form__container-three">
    <div class="form__item form__item--small
      ...
      <input id="lot-rate" type="text" name="lot-rate"
        placeholder="0" value="<?=isset($lot["lot-rate"]) ? $lot["lot-rate"] : ""; ?>">
      <span class="form__error">
        <?=isset($errors["lot-rate"]) ? $errors["lot-rate"] : ""?>
      </span>
    </div>
    <div class="form__item form__item--small
      ...
      <input id="lot-step" type="text" name="lot-step"
        placeholder="0" value="<?=isset($lot["lot-rate"]) ? $lot["lot-step"] : ""; ?>">
      <span class="form__error">
        <?=isset($errors["lot-step"]) ? $errors["lot-step"] : ""?>
      </span>
    </div>
